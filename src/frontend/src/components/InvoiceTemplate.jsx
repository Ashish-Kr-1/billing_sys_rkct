...
export default function InvoiceTemplate({ invoice, subtotalAmount, totalAmount, sgst, cgst, igst, showTax, companyConfig }) {
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-0">
        <img
          src={getCompanyLogo()}
          alt="watermark"
          className="w-[600px] opacity-[0.10]"
          style={{ transform: 'rotate(-30deg)', filter: 'grayscale(100%)' }}
        />
      </div>
